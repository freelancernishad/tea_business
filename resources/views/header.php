...
<head>
	...
	<link rel='stylesheet' id='chaitan_google_fonts-css'
		href='//fonts.googleapis.com/css?family=Open+Sans:400,600,700,800%7CPlayfair+Display:400,400i,700,700i,900&#038;subset=latin-ext'
	...
	<link rel="stylesheet" href="../assets/css/vs_shortcode.css">
							...
							<ul class="sub-menu">
								<li id="menu-item-623"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-623"><a
										href="http://chaitan.like-themes.com/shop/"><span>Shop</span></a></li>
								<li id="menu-item-622"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-622"><a
										href="http://chaitan.like-themes.com/cart/"><span>Cart</span></a></li>
								<li id="menu-item-621"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-621"><a
										href="http://chaitan.like-themes.com/checkout/"><span>Checkout</span></a></li>
								<li id="menu-item-620"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-620"><a
										href="http://chaitan.like-themes.com/my-account/"><span>My account</span></a>
								</li>
							</ul>
						</li>
						<li id="menu-item-59"
					...
					<div class="ltx-navbar-icons">
						<ul>
							...
							<li
								...
								<a href="http://chaitan.like-themes.com/my-account/"><span class="fa fa-user"></span>
									Login</a>
							</li>
						</ul>
					</div>
						...
						<div>
							<ul>
								...
								<li class="ltx-fa-icon ltx-nav-profile menu-item-has-children ">
									<a href="http://chaitan.like-themes.com/my-account/"><span
