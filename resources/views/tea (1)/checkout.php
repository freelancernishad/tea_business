                    ...
                    <div class="entry-content clearfix" id="entry-div">
                        <div class="woocommerce">
                            ...
                            <form class="woocommerce-form woocommerce-form-login login" method="post"
                                ...
                                <p class="form-row">
                                    <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce"
                                        value="f05ad74703"><input type="hidden" name="_wp_http_referer"
                                        value="/checkout/"> <button type="submit" class="btn btn-default btn-xs"
                                        name="login" value="Login">Login</button>
                                    <input type="hidden" name="redirect"
                                        value="http://chaitan.like-themes.com/checkout/">
                                ...
                                <p class="lost_password">
                                    <a href="http://chaitan.like-themes.com/my-account/lost-password/">Lost your
                                        password?</a>
                                </p>
                            ...
                            <form class="checkout_coupon woocommerce-form-coupon" method="post" style="display:none">
                                ...
                                <p class="form-row form-row-last">
                                    <button type="submit" class="btn btn-default btn-xs" name="apply_coupon"
                            ...
                            <form name="checkout" method="post" class="checkout woocommerce-checkout"
                                action="http://chaitan.like-themes.com/checkout/" enctype="multipart/form-data"
                                                        ...
                                                        class="woocommerce-input-wrapper"><select name="billing_country"
                                                            ...
                                                            dir="ltr" style="width: 100%;"><span class="selection"><span
                                                                    ...
                                                                    role="combobox"><span
                                                                        ...
                                                                        title="Bangladesh">Bangladesh</span><span
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    An Xi Mao Xie&nbsp; <strong class="product-quantity">× 2</strong>
                                                </td>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="order-total">
                                                ...
                                                <td><strong><span class="woocommerce-Price-amount amount"><span
                                                                class="woocommerce-Price-currencySymbol">$</span>6.00</span></strong>
                                                </td>
                                            </tr>
                                    ...
                                    <div id="payment" class="woocommerce-checkout-payment">
                                        ...
                                        <div class="form-row place-order">
                                            ...
                                            <input type="hidden" id="woocommerce-process-checkout-nonce"
                                                name="woocommerce-process-checkout-nonce" value="1404a8c25f"><input
